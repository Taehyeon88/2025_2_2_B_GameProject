...
public class CityGenerator : MonoBehaviour
{
    ...
    public int maxButidingHeight = 15;
    ...
    {
        int floors = Random.Range(minBuildingHeight, maxButidingHeight);
    ...
    private void CreatePark(int x, int z)
    {
        ...
        for(int i = 0; i < 3;  i++)
        {
            ...
            tree.transform.SetParent(tree.transform);
    ...
    private void CreatePlaza(int x, int z)
    {
        ...
        GameObject foundtain = GameObject.CreatePrimitive(PrimitiveType.Cube);
        foundtain.transform.position = new Vector3(x * blockSize, 1f, z * blockSize);
        foundtain.transform.localScale = new Vector3(2f, 1f, 2f);
        foundtain.transform.SetParent(plaza.transform);
        foundtain.GetComponent<Renderer>().material.color = Color.cyan;
    }
    ...
    private void CreateStreetLight(int x, int z)
    {
        ...
        pole.transform.position = new Vector3(x * blockSize, 10f, z * blockSize);
        pole.transform.localScale = Vector3.one * 0.5f;
        pole.transform.SetParent(pole.transform);
    ...
    private void ClearCity()                      //도시 클리어하기
    {
